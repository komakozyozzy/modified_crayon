...
(function() {
  ...
  this.addFacility = function() {
    return $('#facTable').append('<tr>' + '<td><label for="name" >Facility Name :  </label></td>' + '<td><input type="text" name="facility[]" value=""/></td>' + '<td><input type="hidden" name="facility_id[]" value="0"/></td>' + '</tr>');
  };
  ...
  gotFacs = function(data) {
    ...
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      x = data[_i];
      _results.push($('#facTable').append('<tr>' + '<td><label for="name" >Facility Name :  </label></td>' + '<td><input type="text" name="facility[]" value="' + x.name + '"/></td>' + '<td><input type="hidden" name="facility_id[]" value="' + x.id + '"/>' + '<img src="include/image/delete.png" onclick="deleteFacility(this, 0)" /></td>' + '</tr>'));
    }
    return _results;
  };
  ...
  gotInspections = function(data) {
    ...
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      x = data[_i];
      _results.push($('#ins_select').append('<option value="' + x.data_path + '">' + x.timestamp + '</option>'));
    }
    return _results;
  };
